...
## once this has run once dont need to repeat it ###
...
unaff_list <- lapply(Sys.glob("PHD_2ndYR/Slim/Output/ROH_output/testing_output_loop*.hom.summary"), read.table, header = TRUE, stringsAsFactors=FALSE)
